      ...
      <div class="inside">
         <form method="post" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>">
            <ul class="gleft">
               ...
               <li class="descrip">
                        <?php _e("notifikasi via email pejabat PID bila ada user baru terdaftar<br/>
notifikasi via email pejabat PID bila ada pertanyaan yg sudah lewat dari xxx hari belum terjawab<br/>
notifikasi via email ke penanya bila pertanyaannya dijawab/ditolak", 'custom-contact-forms'); ?>
                       </li>
            </ul>
            <ul class="gright">
               <br />
